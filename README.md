Внимание! Это форк учебного проекта от https://github.com/neuro-fill/51-lesson.git
В этом форке реализован механизм оповещения о низком балансе через telegram api в личные сообщения от вашего бота. Остальное описание оставлено без изменений.
